 ...
 *   8  = VISITANTES
 */
export const HIK_ORG_ROLE_MAP: Record<string, string> = {
 ...
 */
export const HIK_ORG_NAMES: Record<string, string> = {
    '1': 'ALL DEPARTMENTS',
    '2': 'MORADORES',
    '3': 'PRESTADORES',
    '4': 'PORTARIA',
 ...
 */
export const FALLBACK_ORG_CODES = {
    RESIDENT: ['2', '7'],
    PRESTADOR: ['3'],
    STAFF: ['4', '5', '6'],
    SYSTEM: ['1'],
 ...
 */
export const HIK_VISITOR_STATUS = {
 ...
 */
export function resolveRoleFromOrg(orgIndexCode: string): string {
